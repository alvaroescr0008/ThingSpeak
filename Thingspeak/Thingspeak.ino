...
//////////////////////////////////////////////////////
  ...
  const char WiFiSSID[] = "actividades fisicas 2";
  const char WiFiPSK[] = "fpedufisR11";
#endif
...
//////////////////////////////////////////////////////
  ...
  String MyWriteAPIKey="01RVOY20ZCG7K7HU"; // Escribe la clave de tu canal ThingSpeak
#else 
...
void setup() {
  ...
  connectWiFi();//                                                               PONER CREO ESTA FUNCION
...
void loop() {
    ...
    data[ 1 ] = String( humedad ); //                                                                                           humedad
    #ifdef PRINT_DEBUG_MESSAGES
        Serial.print( "humedad = " );
        Serial.println( data[ 1 ] );
    #endif

    data[ 2 ] = String( salinidad ); //                                                                                         salinidad
    #ifdef PRINT_DEBUG_MESSAGES
        Serial.print( "salinidad = " );
        Serial.println( data[ 2 ] );
    #endif    
    
    data[ 3 ] = String( temperatura); //                                                                                            temperatura
    #ifdef PRINT_DEBUG_MESSAGES
        ...
        Serial.println( data[ 3 ] );
            ...
            data[ 4 ] = String( luminosidad ); //                                                                                  luminosidad
    #ifdef PRINT_DEBUG_MESSAGES
